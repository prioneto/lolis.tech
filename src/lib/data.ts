...
export const skillsData = ["HTML", "CSS", "JavaScript", "TypeScript", "AI", "React", "Next.js", "Node.js", "Git", "Tailwind", "MongoDB", "Express", "PostgreSQL", "Python", "Django", "Framer Motion", "Unity", "C#"] as const;
